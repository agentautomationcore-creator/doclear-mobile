  ...
  const handleExportPDF = useCallback(async () => {
    ...
    const html = `
      <html><head><meta charset="utf-8"><style>
        ...
        <p style="margin-top:32px;color:#64748b;font-size:12px;">Generated by DocLear &mdash; doclear.app</p>
      </body></html>
    `;
    try {
        ...
        {!doc.whatIsThis && !doc.whatItSays ? (
          <Card style={{ marginBottom: 16, backgroundColor: '#FEF3C7' }}>
            ...
            <Text style={{ fontSize: FONT_SIZE.caption, color: '#92400E', lineHeight: 20 }}>
              Analysis incomplete. Some sections may be missing. Try asking a question below for more details.
            </Text>
          </Card>
        ) : null}
